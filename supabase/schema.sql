...
create index if not exists products_sort_order_idx on public.products(active, sort_order, created_at desc);
...
-- ============================================================
-- 4.1 PRODUCT VARIANTS (e.g. Colors)
-- ============================================================
...
-- PRODUCT VARIANTS: readable if the parent product is readable; admin writes
...
-- Product Series & Models (standalone products keep product_type = 'product')
