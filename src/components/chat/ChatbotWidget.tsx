...
export default function ChatbotWidget() {
  ...
  useEffect(() => {
    // Lazy load welcome message to improve initial page load
    ...
    }, 1000); // Delay initial message by 1 second
                              ...
                              <div className="grid gap-2">
                                {msg.products.map((product) => {
                                  ...
                                  const whatsappUrl = `https://wa.me/923489593671?text=${encodeURIComponent(
                                    `Hi STH Gadgets! I am interested in ${product.name} (PKR ${product.price}). Is it available?`
                                  )}`;
