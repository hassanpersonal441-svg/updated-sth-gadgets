  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 left-4 z-40 flex items-center gap-2 rounded-full border border-amber-500/50 bg-gradient-to-r from-amber-500 via-rose-500 to-amber-600 px-3.5 py-2 font-display text-xs font-black text-white shadow-[0_0_20px_rgba(245,158,11,0.4)] transition hover:scale-105 animate-pulse cursor-pointer"
