    ...
    <div className="space-y-6 text-[#C9D2DB]" suppressHydrationWarning>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col-reverse sm:flex-row gap-3 items-start">
          ...
          <div className="relative aspect-square w-full max-w-[480px] max-h-[480px] mx-auto sm:mx-0 overflow-hidden rounded-2xl border-2 border-[#00C4CC]/40 bg-[#08101A] shadow-[0_0_30px_rgba(0,196,204,0.2)] group flex-1">
            <Image
            ...
            <button
              ...
              className="absolute bottom-3 right-3 z-10 rounded-xl bg-slate-900/80 p-2 text-slate-300 hover:text-white border border-slate-700 text-sm shadow-md"
              title="Expand view"
            >
              ⛶
            </button>
        ...
        <div className="lg:col-span-4 space-y-3.5">
          ...
          {/* 2 Trust Badges Row */}
          <div className="grid grid-cols-2 gap-1.5 pt-2 border-t border-slate-800/80 text-[10px] text-slate-300 text-center">
        ...
        <div className="sm:col-span-12 lg:col-span-3 rounded-2xl border border-[#00C4CC]/30 bg-[#08101A] p-4 space-y-4 shadow-[0_0_20px_rgba(0,196,204,0.08)]">
              ...
              <ul className="space-y-2 text-xs text-slate-300">
                {product.key_features.map((kf, i) => (
                  <li key={i} className="flex items-center gap-2">
                    <span className="text-[#00C4CC] font-bold">{kf.icon || '✓'}</span>
                    <span>
                      <strong className="text-white">{kf.title}</strong>
                      {kf.subtitle ? <span className="text-slate-400 ml-1">({kf.subtitle})</span> : ''}
                    </span>
                  </li>
                ))}
              </ul>
          ...
          {/* Specifications List */}
          <div className={product.key_features && product.key_features.length > 0 ? 'border-t border-slate-800/80 pt-3' : ''}>
      ...
      {product.bundle_offers && product.bundle_offers.length > 0 && (
        <div className="rounded-2xl border border-amber-500/30 bg-gradient-to-br from-[#0C1420] via-[#0F1C2D] to-[#080D15] p-5 sm:p-6 space-y-6 shadow-[0_0_25px_rgba(0,196,204,0.08)]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800 pb-4">
            ...
            <span className="self-start sm:self-auto rounded-full border border-amber-400/40 bg-amber-400/10 px-3.5 py-1 text-xs font-black text-amber-300 uppercase tracking-wider">
          ...
          <div className="space-y-6">
            {product.bundle_offers.map((bundle, bIdx) => {
              ...
              return (
                <div
                  key={bIdx}
                  className="relative rounded-xl border border-amber-500/30 bg-[#080D15] p-3 sm:p-4 hover:border-[#00C4CC]/50 transition shadow-sm text-[#C9D2DB]"
                >
                  {/* Badge */}
                  {bundle.badge_text && (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch">
                    ...
                    <div className="lg:col-span-7 space-y-3 flex flex-col justify-between">
                      <div className="space-y-2.5">
                        ...
                        <div className="p-2.5 sm:p-3 rounded-lg border border-slate-800 bg-[#0C1420] space-y-1.5">
                    ...
                    <div className="lg:col-span-5 flex flex-col justify-between h-full">
                      <div className="p-3 sm:p-3.5 rounded-xl border border-slate-800 bg-[#0C1420] space-y-3 flex-1 flex flex-col justify-between">
                        <div className="space-y-2.5">
                          <span className="text-[10px] font-bold uppercase tracking-wider block border-b border-slate-800 pb-1.5 text-slate-400">
                          ...
                          {bundleSavings > 0 && (
                            <div className="pt-1">
                              <div className="flex items-center justify-between p-2 rounded-lg border border-emerald-500/30 bg-emerald-500/15 text-xs font-bold text-emerald-400">
